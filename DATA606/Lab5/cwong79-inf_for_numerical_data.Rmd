...
We can see min and max ages of both the younger and mature mothers. In this instance, younger ~ 13 to 34 and mature ~ 35 to 50.
...
The response variable that I am interested in: `nc$visits`. The second argument is the explanatory variable, 
`x`, which is the variable that splits the data into two groups, low and not low: `nc$lowbirthweight`. The third argument, `est`, is the parameter I wanted to review: `"mean"`. I am performing a hypothesis test in this istance. 

I wanted to determine if hospital visits impact birth weight. This will conclude the importance of regular visits as an indicator for healthy weight babies.

N0: Less or more visits to hospital equals to low birth weight
NA: Less or more visits to the hospital does not equal to low birth weight

Based on the p-value of 0.0024, we can reject the null hypothesis. We can see that there is a definitive birth weight impact based on hospital visit amounts.
