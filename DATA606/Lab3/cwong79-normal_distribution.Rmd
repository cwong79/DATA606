...
The stepwise pattern could be due to the use of discrete values in the sample.
...
Based on these plots, the data appears to be right skewed. I can check this against the attached histogram.
